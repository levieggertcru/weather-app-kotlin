...
@required
- (SharedFlowWrapper<SharedCurrentWeatherDomainModel *> *)getCurrentWeatherZipCode:(NSString *)zipCode __attribute__((swift_name("getCurrentWeather(zipCode:)")));
@end
...
@required
- (SharedFlowWrapper<SharedLatestWeatherSearchesDomainModel *> *)getSearches __attribute__((swift_name("getSearches()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LatestWeatherSearchesDomainModel")))
@interface SharedLatestWeatherSearchesDomainModel : SharedBase
- (instancetype)initWithWeatherSearches:(NSArray<SharedWeatherSearchDomainModel *> *)weatherSearches __attribute__((swift_name("init(weatherSearches:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<SharedWeatherSearchDomainModel *> *weatherSearches __attribute__((swift_name("weatherSearches")));
@end
...
- (SharedFlowWrapper<SharedCurrentWeatherDomainModel *> *)searchZipCode:(NSString *)zipCode __attribute__((swift_name("search(zipCode:)")));
@end
